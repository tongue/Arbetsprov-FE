...
const sunWeatherCodes: WeatherCode[] = [113, 116];
const cloudWeatherCodes: WeatherCode[] = [
  116, 119, 122, 143, 182, 200, 248, 260,
];
const rainWeatherCodes: WeatherCode[] = [
  176, 263, 266, 281, 293, 296, 299, 302, 305, 308, 311, 314, 353, 356, 359,
  386, 389,
];
const snowWeatherCodes: WeatherCode[] = [
  179, 227, 230, 317, 320, 323, 326, 329, 332, 335, 338, 350, 362, 365, 368,
  371, 374, 377, 392, 395,
];

/** Map of WeatherCode and WeatherTag */
const weatherCodeTagMap: [WeatherCode[], WeatherTag][] = [
...
export const weatherTags = (weatherCode: WeatherCode): WeatherTag[] =>
  weatherCodeTagMap.reduce(
    (previousTags, [currentWeatherCodes, currentTag]) =>
      currentWeatherCodes.includes(weatherCode)
